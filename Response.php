...
class Response{
    /**
     * @var Fast parent Application
     */
    private $_base_url='';
    /**
     * @var string output http code
     */
    private $_out_code='200';
    /**
     ...
     * @param number $number
     */
    public function set_out_Code($number=200){
        $this->_out_code=$number;
    }
    /**
    ...
    public function flash(){
        $this->_flash($this->_out_code,$this->_cookies,$this->_headers, $this->_body);
        $this->_body='';
        $this->_out_code=200;
        $this->_cookie=array();
        $this->_headers=array();
    ...
    private function _flash($code,$cookies,$header,$body){
        ...
        if(!$this->_sended_header){
            //code
            $codetxt=isset(self::$codes[$code])?self::$codes[$code]:'unKnown';
